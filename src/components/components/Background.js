    ...
    return (
        <section class="clearfix" style={{}}>
            ...
            <ul class="solarsystem">
                <li class="sun"><a href="#sun"><span>सूर्य</span></a></li>
                <li class="mercury"><a href="#mercury"><span>बुध</span></a></li>
                <li class="venus"><a href="#venus"><span>शुक्र</span></a></li>
                <li class="earth"><a href="#earth"><span>पृथ्वी और चंद्रमा</span></a></li>
                <li class="mars"><a href="#mars"><span>मंगल</span></a></li>
                <li class="asteroids_meteorids"><span>क्षुद्रग्रह और उल्का पिंड</span></li>
                <li class="jupiter"><a href="#jupiter"><span>बृहस्पति</span></a></li>
                <li class="saturn"><a href="#saturn"><span>शनि</span></a></li>
                <li class="uranus"><a href="#uranus"><span> अरुण</span></a></li>
                <li class="neptune"><a href="#neptune"><span>वरुण</span></a></li>
                <li class="pluto"><a href="#pluto"><span>प्लूटो</span></a></li>
            </ul>
